...
struct KeyboardEnhancementFlags(Equatable, ImplicitlyCopyable, TrivialRegisterType):
...
@fieldwise_init
struct KeyModifiers(Equatable, ImplicitlyCopyable, Stringable, TrivialRegisterType, Writable):
...
@fieldwise_init
struct KeyEventState(Equatable, ImplicitlyCopyable, Stringable, TrivialRegisterType, Writable):
...
@fieldwise_init
struct KeyEventKind(Equatable, ImplicitlyCopyable, Stringable, TrivialRegisterType, Writable):
...
@fieldwise_init
struct MediaKeyCode(Equatable, ImplicitlyCopyable, KeyType, TrivialRegisterType):
...
@fieldwise_init
struct ModifierKeyCode(Equatable, ImplicitlyCopyable, KeyType, Stringable, TrivialRegisterType):
...
@fieldwise_init
struct Backspace(ImplicitlyCopyable, KeyType, TrivialRegisterType):
...
@fieldwise_init
struct Enter(ImplicitlyCopyable, KeyType, TrivialRegisterType):
    var remove_later: Bool
    """Only here because of a bug in the complier with empty structs."""
...
@fieldwise_init
struct Left(ImplicitlyCopyable, KeyType, TrivialRegisterType):
    var remove_later: Bool
    """Only here because of a bug in the complier with empty structs."""
...
@fieldwise_init
struct Right(ImplicitlyCopyable, KeyType, TrivialRegisterType):
    var remove_later: Bool
    """Only here because of a bug in the complier with empty structs."""
...
@fieldwise_init
struct Up(ImplicitlyCopyable, KeyType, TrivialRegisterType):
    var remove_later: Bool
    """Only here because of a bug in the complier with empty structs."""
...
@fieldwise_init
struct Down(ImplicitlyCopyable, KeyType, TrivialRegisterType):
    var remove_later: Bool
    """Only here because of a bug in the complier with empty structs."""
...
@fieldwise_init
struct Home(ImplicitlyCopyable, KeyType, TrivialRegisterType):
    var remove_later: Bool
    """Only here because of a bug in the complier with empty structs."""
...
@fieldwise_init
struct End(ImplicitlyCopyable, KeyType, TrivialRegisterType):
    var remove_later: Bool
    """Only here because of a bug in the complier with empty structs."""
...
@fieldwise_init
struct PageUp(ImplicitlyCopyable, KeyType, TrivialRegisterType):
    var remove_later: Bool
    """Only here because of a bug in the complier with empty structs."""
...
@fieldwise_init
struct PageDown(ImplicitlyCopyable, KeyType, TrivialRegisterType):
    var remove_later: Bool
    """Only here because of a bug in the complier with empty structs."""
...
@fieldwise_init
struct Tab(ImplicitlyCopyable, KeyType, TrivialRegisterType):
    var remove_later: Bool
    """Only here because of a bug in the complier with empty structs."""
...
@fieldwise_init
struct BackTab(ImplicitlyCopyable, KeyType, TrivialRegisterType):
    var remove_later: Bool
    """Only here because of a bug in the complier with empty structs."""
...
@fieldwise_init
struct Delete(ImplicitlyCopyable, KeyType, TrivialRegisterType):
    var remove_later: Bool
    """Only here because of a bug in the complier with empty structs."""
...
@fieldwise_init
struct Insert(ImplicitlyCopyable, KeyType, TrivialRegisterType):
    var remove_later: Bool
    """Only here because of a bug in the complier with empty structs."""
...
@fieldwise_init
struct Null(ImplicitlyCopyable, KeyType, TrivialRegisterType):
    var remove_later: Bool
    """Only here because of a bug in the complier with empty structs."""
...
@fieldwise_init
struct Esc(ImplicitlyCopyable, KeyType, TrivialRegisterType):
    var remove_later: Bool
    """Only here because of a bug in the complier with empty structs."""
...
@fieldwise_init
struct CapsLock(ImplicitlyCopyable, KeyType, TrivialRegisterType):
    var remove_later: Bool
    """Only here because of a bug in the complier with empty structs."""
...
@fieldwise_init
struct ScrollLock(ImplicitlyCopyable, KeyType, TrivialRegisterType):
    var remove_later: Bool
    """Only here because of a bug in the complier with empty structs."""
...
@fieldwise_init
struct NumLock(ImplicitlyCopyable, KeyType, TrivialRegisterType):
    var remove_later: Bool
    """Only here because of a bug in the complier with empty structs."""
...
@fieldwise_init
struct PrintScreen(ImplicitlyCopyable, KeyType, TrivialRegisterType):
    var remove_later: Bool
    """Only here because of a bug in the complier with empty structs."""
...
@fieldwise_init
struct Pause(ImplicitlyCopyable, KeyType, TrivialRegisterType):
    var remove_later: Bool
    """Only here because of a bug in the complier with empty structs."""
...
@fieldwise_init
struct Menu(ImplicitlyCopyable, KeyType, TrivialRegisterType):
    var remove_later: Bool
    """Only here because of a bug in the complier with empty structs."""
...
@fieldwise_init
struct KeypadBegin(ImplicitlyCopyable, KeyType, TrivialRegisterType):
    var remove_later: Bool
    """Only here because of a bug in the complier with empty structs."""
...
@fieldwise_init
struct FunctionKey(ImplicitlyCopyable, KeyType, TrivialRegisterType):
    var number: UInt8
...
@fieldwise_init
struct MouseButton(Equatable, ImplicitlyCopyable, Stringable, TrivialRegisterType, Writable):
...
@fieldwise_init
struct MouseDown(Equatable, ImplicitlyCopyable, MouseEventType, TrivialRegisterType):
    """Pressed mouse button."""

    var button: MouseButton

    fn write_to(self, mut writer: Some[Writer]):
        writer.write("MouseDown(", self.button, ")")


@fieldwise_init
struct MouseUp(Equatable, ImplicitlyCopyable, MouseEventType, TrivialRegisterType):
    """Released mouse button."""

    var button: MouseButton

    fn write_to(self, mut writer: Some[Writer]):
        writer.write("MouseUp(", self.button, ")")


@fieldwise_init
struct MouseDrag(Equatable, ImplicitlyCopyable, MouseEventType, TrivialRegisterType):
...
@fieldwise_init
struct MouseMoved(Equatable, ImplicitlyCopyable, MouseEventType, TrivialRegisterType):
...
@fieldwise_init
struct MouseScrollDown(Equatable, ImplicitlyCopyable, MouseEventType, TrivialRegisterType):
...
@fieldwise_init
struct MouseScrollUp(Equatable, ImplicitlyCopyable, MouseEventType, TrivialRegisterType):
...
@fieldwise_init
struct MouseScrollLeft(Equatable, ImplicitlyCopyable, MouseEventType, TrivialRegisterType):
...
@fieldwise_init
struct MouseScrollRight(Equatable, ImplicitlyCopyable, MouseEventType, TrivialRegisterType):
...
struct MouseEventKind(ImplicitlyCopyable, Stringable, Writable):
    ...
    @implicit
    fn __init__(out self, value: MouseDown):
        self.event = value

    @implicit
    fn __init__(out self, value: MouseUp):
        self.event = value
    ...
    fn write_to(self, mut writer: Some[Writer]):
        if self.isa[MouseDown]():
            writer.write(self[MouseDown])
        elif self.isa[MouseUp]():
            writer.write(self[MouseUp])
...
@fieldwise_init
struct MouseEvent(ImplicitlyCopyable, Writable):
    ...
    MouseUp and MouseDrag events. MouseButton.Left is returned if we don't know
...
@fieldwise_init
struct FocusGained(EventType, ImplicitlyCopyable, TrivialRegisterType):
...
@fieldwise_init
struct FocusLost(EventType, ImplicitlyCopyable, TrivialRegisterType):
...
@fieldwise_init
struct Resize(EventType, ImplicitlyCopyable, TrivialRegisterType):
