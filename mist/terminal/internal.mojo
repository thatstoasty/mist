from mist.terminal.event import Char, Event, KeyboardEnhancementFlags
...
@fieldwise_init
struct PrimaryDeviceAttributes(ImplicitlyCopyable, InternalEventType, Stringable, TrivialRegisterType, Writable):
