...
def change_scrolling_region_sequence(top: UInt16, bottom: UInt16) -> String:
...
def change_scrolling_region(top: UInt16, bottom: UInt16) -> None:
    """Sets the scrolling region of the terminal.
...
def insert_lines_sequence(n: UInt16) -> String:
...
def insert_lines(n: UInt16) -> None:
    """Inserts the given number of lines at the top of the scrollable
    region, pushing lines below down.
...
def delete_lines_sequence(n: UInt16) -> String:
...
def delete_lines(n: UInt16) -> None:
    """Deletes the given number of lines, pulling any lines in
    the scrollable region below up.
...
def set_window_title(title: StringSlice) -> None:
...
def resize_terminal(width: UInt, height: UInt) -> None:
...
def set_foreground_color(color: AnyColor) -> None:
...
def set_background_color(color: AnyColor) -> None:
...
def enable_alternate_screen() -> None:
...
def disable_alternate_screen() -> None:
