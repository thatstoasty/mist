...
from ffi import _get_global, external_call
from mist.styles.color import ANSI256Color, ANSIColor, AnyColor, NoColor, RGBColor, ansi256_to_ansi, hex_to_ansi256
...
struct Profile(Comparable, ImplicitlyCopyable, Representable, Stringable, TrivialRegisterType, Writable):
