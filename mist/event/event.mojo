...
struct KeyEvent(Equatable, EventType, ImplicitlyCopyable, Writable):
    ...
    def __init__(out self, code: KeyCode, modifiers: KeyModifiers, kind: KeyEventKind = KeyEventKind.Press):
...
struct Event(Copyable, InternalEventType, Writable):
    ...
    def __getitem_param__[T: EventType](ref self) -> ref[self.value] T:
